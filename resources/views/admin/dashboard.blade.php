                            ...
                            <li class="nav-item lh-1 me-3">
                                <a class="dropdown-item" href="{{ url('#') }}">
                                    <span class="d-flex align-items-center align-middle">
                                        ...
                                        <span class="flex-grow-1 align-middle me-2"> Pemberitahuan</span>
                                        <span
                                        ...
                                        <a class="dropdown-item" href="{{ url('#') }}">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small
                                                        class="text-muted text-capitalize">{{ Auth::user()->roles->pluck('name')[0] }}</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                ❤️
                                <a href="/" target="_blank" class="footer-link fw-bolder">PT. Penjaminan Kredit Indonesia</a>
                            </div>
                            <div>
